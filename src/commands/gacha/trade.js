    ...
    async execute(ctx) {
        ...
        if (command === 'aceptar') {
            ...
            if (char1.owner !== initiator || char2.owner !== targetUser) {
                ...
                return await reply(styleText('ꕢ El intercambio falló porque uno de los personajes ya no pertenece al dueño original.'));
            }
            ...
            // Fix: Initialize gacha objects if missing
