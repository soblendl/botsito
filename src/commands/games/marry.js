...
export default {
    ...
    async execute(ctx) {
        ...
        if (!partner || partner === sender) return await ctx.reply(styleText('💒 *MATRIMONIO VIRTUAL*\n\nMenciona o responde a alguien:\n• #marry @persona\n• Responder + #marry\n\n> ¡No puedes casarte solo!'));
        ...
        const text = `💍 *¡BODA VIRTUAL!*\n\n> 👰 ${name1}\n    ❤️ + 💕 + ❤️\n> 🤵 ${name2}\n------------------------------\n> *Lugar* » ${ceremony}\n> *Regalo* » ${gift}\n> *Futuro* » ${future}\n\n${rings} *Amor* » ${loveScore}%\n------------------------------\n✨ Los declaro oficialmente casados virtuales ✨\n> Que vivan felices por siempre~`.trim();
        await ctx.bot.sendMessage(chatId, { text: styleText(text), mentions: [sender, partner] }, { quoted: msg });
    }
};
